        ...
        <div className="mt-16 cloud-card-lg p-8 lg:p-12 preview-fade-in preview-fade-in-delay-2">
          <div className="grid md:grid-cols-3 gap-8 mb-10">
            <div>
              ...
              <p className="heading-md text-navy">E-Book & Hardcopy</p>
            </div>
            <div>
              <p className="text-sm text-gray-500 mb-2">Language</p>
              <p className="heading-md text-navy">English</p>
            </div>
            <div>
              <p className="text-sm text-gray-500 mb-2">Edition</p>
              <p className="heading-md text-navy">First Edition 2026</p>
            </div>
          </div>

          <div className="w-full h-px bg-[#dccaa2] mb-10" />
